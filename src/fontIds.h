...
// NOTE: OpenDyslexic fonts have been removed to save space
// Bookerly and NotoSans (with Greek support) and Ubuntu UI fonts are included
...
#define NOTOSANS_8_FONT_ID (1073217904)
